...
recipe2.instructions.create!([
  ...
  # create some dishes
Dish.create(title: 'Tacos', subtitle: 'Mexico', image_url: 'https://media.istockphoto.com/id/1413248571/photo/two-tacos-with-ground-beef-and-lime-on-white-background.jpg?s=1024x1024&w=is&k=20&c=zkcNCJqbTPLJj0D5rYso2OtqDH7thUmtSrU6gYv1QlI=', description: 'A taco is a traditional Mexican food consisting of a small hand-sized corn- or wheat-based tortilla topped with a filling. The tortilla is then folded around the filling and eaten by hand')
Dish.create(title: 'Sushi', subtitle: 'Japan', image_url: 'https://cdn.britannica.com/54/171754-050-7D16E0FC/Sushi-rolls-California.jpg', description: 'Sushi is a Japanese dish of prepared vinegared rice, usually with some sugar and salt, accompanied by a variety of ingredients, such as seafood, often raw, and vegetables. Styles of sushi and its presentation vary widely, but the one key ingredient is "sushi rice", also referred to as shari, or sumesh')
Dish.create(title: 'Pizza', subtitle: 'Italy', image_url: 'https://www.simplyrecipes.com/thmb/X2B0QCVdGJWGO1gW6GR7cz1rhe0=/750x0/filters:no_upscale():max_bytes(150000):strip_icc():format(webp)/__opt__aboutcom__coeus__resources__content_migration__simply_recipes__uploads__2019__09__easy-pepperoni-pizza-lead-3-8f256746d649404baa36a44d271329bc.jpg', description: 'Pizza is a dish of Italian origin consisting of a usually round, flat base of leavened wheat-based dough topped with tomatoes, cheese, and often various other ingredients, which is then baked at a high temperature, traditionally in a wood-fired oven. A small pizza is sometimes called a pizzetta')
Dish.create(title: 'Pad Thai', subtitle: 'Thailand', image_url'https://www.allrecipes.com/thmb/kPvumAqg_iW6mUtvGZx_ajTA498=/1500x0/filters:no_upscale():max_bytes(150000):strip_icc():format(webp)/42968-pad-thai-4x3-1530-2a60081848f745379461240c5edcca3d.jpg', description: 'Pad Thai is a stir-fried rice noodle dish commonly served as a street food and at casual local eateries in Thailand. It is made with soaked dried rice noodles, which are stir-fried with eggs and chopped firm tofu, and flavored with tamarind pulp, fish sauce, dried shrimp, garlic or shallots, red chili pepper and palm sugar, and served with lime wedges and chopped roasted peanuts')
Dish.create(title: 'Falafel', subtitle: 'Middle East', image_url 'https://media.istockphoto.com/id/1313425908/photo/falafel-and-dipping-sauce-top-view.jpg?s=1024x1024&w=is&k=20&c=N3XOO8I6KZvNelstpYjtccH5R2KbzK9ACjKiP7hPAsc=', description: 'A carrot cake hailing from Northern Italy, Torta di Carote is a light, elegant dessert that contains no butter, oil, or dairy. This healthy carrot cake recipe has a subtle sweetness from early summer carrots, orange zest, and a small amount of sugar especially when compared to American carrot cakes.')
